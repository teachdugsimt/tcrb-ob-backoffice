...
import { Button, Row, Col, PageHeader, Table, Select } from 'antd'
    ...
    (observer((props) => {
        ...
        return (
          <Form
            ...
            initialValues={{
              ...
              'product_name_eng': productOnboardStore.productDetailSelected.product_name_english,
      ...
      return (
        <div>
          ...
          {isEditProduct ? <FormEditProductOnBoard onSubmitEditProduct={submitEditProduct} /> : <FormViewDetailProductOnBoard />}
          <Row>
            <Col>
