  ...
  inject('authenStore', 'businessParametersSetupStore')
    (observer((props) => {
      ...
      let adminMenu = [
        ...
        { id: 7, name: "SECURITY CODE ENQUIRY", translate: "securityCodeEnquiry", linkTo: "/", color: "#000000", typeLv: "50" },
        { id: 8, name: "NOTIFICATION ENQUIRY", translate: "notificationEnquiry", linkTo: "/", color: "#000000", typeLv: "50" },
        { id: 9, name: "BRANCH LOCATION ENQUIRY", translate: "branchLocation", linkTo: "/", color: "#000000", typeLv: "12" },
        { id: 10, name: "LIVE CHAT ENQUIRY", translate: "liveChat", linkTo: "/", color: "#000000", typeLv: "12" },
        { id: 11, name: "MARKETING ADS ENQUIRY", translate: "marketingAds", linkTo: "/", color: "#000000", typeLv: "12" },
        ...
        { id: 15, name: "USER ACCESS MANAGEMENT ENQUIRY", translate: "useAccessManagementEnquiry", linkTo: "/", color: "#000000", typeLv: "42" },
