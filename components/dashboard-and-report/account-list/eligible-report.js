...
import { csvLink } from "../../../components/data-utility";
...
const EligibleReport = inject("dashboardAndReportStore")(
  observer((props) => {
            ...
            <Col span={12}>
              ...
              <Row gutter={[4, 2]}>
                <Col span={6} style={{ padding: 4 }}>
                  <span>Main Account No.</span>
                </Col>
                <Col span={12}>
                  <Form.Item name="main_account_no">
                    <Input />
                  </Form.Item>
                </Col>
              </Row>
              <Row gutter={[4, 2]}>
                <Col span={6} style={{ padding: 4 }}>
                  <span>Sub Account No.</span>
                </Col>
                <Col span={12}>
                  <Form.Item name="sub_account_no">
                    <Input />
                  </Form.Item>
                </Col>
              </Row>
    ...
    const data = [
      {
        bin_originate_on: "2020-07-10T22:24:20.202Z",
        bin_sftp_on: "2020-07-11T14:33:18.182Z",
      },
      {
        bin_originate_on: "2020-07-20T22:24:20.202Z",
        bin_sftp_on: "2020-07-20T14:33:18.182Z",
      },
    ];

    const headers = [
      { label: "Bin Originate On", key: "bin_originate_on" },
      { label: "Bin SFTP On", key: "bin_sftp_on" },
    ];
    ...
    return (
      <div>
        ...
        {/* <Button className="primary" onClick={() => toggleCollapse()}>
          testClick
        </Button> */}
      </div>
    );
